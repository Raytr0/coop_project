...
<head>
    ...
    <title>School Board Registration</title>
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
    ...
    <div class="form-wrapper">
        <div class="form-container">
            <h1 class="header">School Board Registration</h1>
            <form action="/register/school-board.php" method="POST" class="form">
                ...
                <div class="form-group">
                    <label for="sb-name">School Board Name</label>
                    <input type="text" id="sb-name" class="form-control" placeholder="School Board Name" name="sb_name" required>
                    <span class="error" id="sb-name_error"></span>           
                </div>
                ...
                <div class="form-group">
                    <label for="sb-website">School Board Website</label>
                    <input type="text" id="sb-website" class="form-control" placeholder="School Board Website" name="sb_website" required>
                    <span class="error" id="sb-website_error"></span>           
                </div>
