...
// Checks if a user is currently loged in 
...
{
    // Checks if there was a email verification token
    if (isset($_GET["token"]))
    {
    ...
    // Checks if the user requested to send another email
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
    ...
    <div class="form-wrapper">
        <div class="form-container small">
            ...
            <img class="center" height="150px" width="150px" src="/assets/svg/envelope.svg" alt="Envelop">
            <h1 class="header">Verify your email</h1>
            <span class="center text">A verification email was sent to: <?=htmlentities($user -> getAccountInfo("email"))?></span>

            <div class="last-element"></div>
            <div class="footer"></div>

            <div class="text center">Did not receive the email? <a href="/pages/confirm-email.php?resend=true" class="link">Resend Email</a></div>
        </div>
    </div>
