...
// Queries school board information 
$school_board_query = $db -> query("
    SELECT school_board_id, sb_name FROM school_boards;
");

$school_board_info = $school_board_query -> fetchAll();

if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    $user = new Voter();
    
    $success = $user -> createVoter(
        $_POST["school"],
        $_POST["username"],
        $_POST["password"],
    ...
    // Checks if the user account was succefuly created
    if ($success)
    {
...
$(document).ready(function() {
    $("#school-board").change( function() {
        let boardId = $(this).children("option:selected").val();
        ...
        xhttp.open("GET", "get-schools.php?sboard="+boardId, true);
        xhttp.send();
    });
});
</script>
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
    ...
    <div class="form-wrapper">
        <div class="form-container">
            ...
            <form action="/pages/student.php" method="POST" class="form">
    ...
    <div class="form-group">
        ...
        <select name="school_board" id="school-board" class="form-control" required>
            ...
            <?php foreach ($school_board_info as $school_board): ?> 
                <option value="<?php echo $school_board["school_board_id"]?>">
                    <?php echo $school_board["sb_name"] ?>
                </option>        
            <?php endforeach; ?>
        </select>
        <span class="error" id="school_board_error"></span> 
                ...
                <div class="form-group">
                    ...
                    <select name="school" id="school" class="form-control" required>
                        <option disabled selected value="default">Select a school board first!</option>
                    </select>
                    <span class="error" id="school_error">
                        <?=$error["school"] ?? ""?>
                    </span> 
                </div>
                ...
                <div class="form-group">
                    ...
                    <span class="error" id="gender_error">
                        <?=$error["gender"] ?? ""?>
                    </span> 
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <input type="text" id="birth-date" class="form-control" placeholder="YYYY-MM-DD" name="birth_date" required >    
                        </div>
                    </div>

                    <span class="error" id="birth-date_error">
                        <?=$error["birth-date"] ?? ""?>
                    </span>
                </div>
