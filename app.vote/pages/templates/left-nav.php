<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
	<div class="navbar-header">
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html">
					...
					<h2 class="brand-text mb-0">Skule Vote</h2>
				</a></li>
	...
	<div class="main-menu-content">
		<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			...
			<li class="nav-item" id="nav-profile"><a href="candidate-profile.php"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Profile">Profile</span></a>
			</li>
			<li class="nav-item" id="nav-elections"><a href="election-list.php"><i class="feather icon-list"></i><span class="menu-title" data-i18n="elections">Election List</span></a>
			</li>
			<?php if ($_SESSION['user-type'] == 1 || $_SESSION['user-type'] == 2): ?>
			<li class="nav-item" id="nav-elections"><a href="vote-home.php"><i class="feather icon-check-square"></i><span class="menu-title" data-i18n="elections">Vote</span></a>
			</li>
			<?php endif;?>
